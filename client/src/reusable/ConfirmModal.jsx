      ...
      <div className="bg-card border flex flex-col justify-between border-black h-[210px] p-5 rounded-[5px] w-[400px]">
       ...
       <p className="">{message}</p>
        ...
        <div className="flex justify-end gap-2 w-[200px] ml-auto">
          <button
            onClick={onCancel}
            className="border border-black bg-green-600 flex-1 text-card rounded-[5px] "
          >
            Cancel
          </button>
          <button
            onClick={onConfirm}
            className="px-4 py-2 bg-red-500 border border-black text-white flex-1 rounded hover:bg-red-600"
          >
            Confirm
          </button>
        </div>
