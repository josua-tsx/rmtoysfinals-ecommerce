...
export default function AdminProductOverviewCard({ singleBestSoldProduct, value1, value2, onClick }) {
  ...
  return (
    <div className="border w-full h-full flex gap-4 items-center justify-center border-black rounded-[5px] relative p-2 bg-card">
      <div className="border-black border w-[15px] bg-yellow absolute h-[15px] right-2 top-1 rounded-full">
        ...
        <img src={singleBestSoldProduct?.productImages[0]} alt="product" className=" h-[110px]  w-auto" />

        <div className="p-2 text-xs text-center flex flex-col gap-3">
           <div className="flex flex-col gap-2">
           <p className="uppercase text-lg">{value1}</p>
