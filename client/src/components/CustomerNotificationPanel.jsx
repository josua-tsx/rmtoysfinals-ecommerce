  ...
  return (
    <div className="relative" ref={panelRef}>
      ...
      <button
        ...
        className="relative p-2 text-gray-700 hover:bg-gray-100 rounded-[5px] border border-black shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] hover:shadow-none hover:translate-x-[1px] hover:translate-y-[1px] transition-all bg-white"
      >
        <HiBell size={18} />
        {unreadCount > 0 && (
          ...
          <div className="max-h-64 overflow-y-auto">
            {notifications.length === 0 ? (
              <div className="p-6 text-center text-gray-400">
                <HiBell size={28} className="mx-auto mb-2 opacity-50" />
